...
<?php if ( !theme_get_setting( 'theme943_breadcrumb_show' ) ) :
	$breadcrumb = NULL;
endif; ?>
...
<div id="page-wrapper" class="page-wrapper">
	<div id="page" class="page">
		...
		<header id="header" class="header page-header clearfix" role="banner">
			...
			<div class="<?php if ( theme_get_setting( 'theme943_sticky_menu' ) ) { echo 'stickup '; } ?>header-section-1"> <!-- Sticky menu wrapper -->
				<div class="container-12">
					<div class="grid-12">
						<div class="col1">
							<!-- Logo -->
			...
			<?php if ( $page['header_bottom'] ) : 
				theme943_region_preffix ( 'header_bottom' );
					print render( $page['header_bottom'] );
				theme943_region_suffix ( 'header_bottom' );
			endif; ?>
		</header>
		...
		<div id="main-wrapper" class="main-wrapper clearfix" role="main">
			...
			<?php if ( $page['content_top'] ) : 
				theme943_region_preffix ( 'content_top' );
					print render( $page['content_top'] );
				theme943_region_suffix ( 'content_top' );
			endif; ?>
			...
			<?php if ( $page['content_two'] ) : 
				theme943_region_preffix ( 'content_two' );
					print render( $page['content_two'] );
				theme943_region_suffix ( 'content_two' );
			endif; ?>
			<!-- Region Content bottom -->
			<?php if ( $page['content_bottom'] ) : 
				theme943_region_preffix ( 'content_bottom' );
					print render( $page['content_bottom'] );
				theme943_region_suffix ( 'content_bottom' );
			endif; ?>
		</div>
		...
		<footer id="footer" class="footer page-footer" role="contentinfo">
			...
			<?php if ( $page['footer_top'] ) : 
				theme943_region_preffix ( 'footer_top' );
					print render( $page['footer_top'] );
				theme943_region_suffix ( 'footer_top' );
			endif; ?>
